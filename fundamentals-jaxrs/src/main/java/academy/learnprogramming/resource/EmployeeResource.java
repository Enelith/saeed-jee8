...
public class EmployeeResource {
	...
	URI others = uriInfo.getBaseUriBuilder()
		    .path(EmployeeResource.class)
		    .path(EmployeeResource.class, "getEmployees")
		    .build();

	// URI dept =
	// uriInfo.getBaseUriBuilder().path(DepartmentResource.class).path(DepartmentResource.class,
	// "getDepartmentById")
    ...
    @Consumes({
	    MediaType.APPLICATION_OCTET_STREAM, "image/png", "image/jpeg", "image/jpg" })
    ...
    @Produces({
	    MediaType.APPLICATION_OCTET_STREAM, "image/jpg", "image/png", "image/jpeg" })
